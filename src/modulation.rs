...
static MOD_SOURCE: [ModSource; 8] = [
    ...
    ModSource{function: Parameter::Aftertouch, index_range: (1, 1),               val_range: ValueRange::Float(0.0, 127.0, 0.1), is_global: true},
    ...
    ModSource{function: Parameter::Velocity,   index_range: (1, 1),               val_range: ValueRange::Float(0.0, 127.0, 0.1), is_global: false},
];
